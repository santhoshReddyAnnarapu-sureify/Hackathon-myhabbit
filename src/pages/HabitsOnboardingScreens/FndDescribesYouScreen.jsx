import {
  ...
  const FndDescribesYouScreen = (props) => {
    ...
    const handleDropDownChange = (event) => {
      ...
      console.log("Friend Describes You : ", describeValue);
    };
    ...
    return (
      <RequestHabitsWrapper>
        <RequestHeaderContent>
          <MainHeading>
            Thank you {props.name} Next we would like to get to know you a bit better.
          </MainHeading>
          <SubHeading>What word would your friends most likely use to describe you?</SubHeading>
  
          <FormControl sx={{ m: 0, minWidth: 300 }} style={{ left: 10 }}>
            <InputLabel id="demo-simple-select-autowidth-label">Friend Describes You</InputLabel>
            <Select
  ...
  export default FndDescribesYouScreen;
